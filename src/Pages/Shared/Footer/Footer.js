...
const Footer = () => {
    return (
        ...
        <footer className="p-4 sm:mt-20 bg-slate-300 sm:p-6 dark:bg-gray-900">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <Link to="/" className="hover:underline">Recycle Bin</Link>
                            </li>
                            <li>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to="https://flowbite.com/" className="hover:underline">RecycleBin™</Link>. All Rights Reserved.
                </span>
