        ...
        <div>
            <div className="card lg:card-side bg-gradient-to-r from-white to-teal-900">
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title sm:text-lg text-xs"><span className='text-teal text-xs sm:text-2xl sm:font-bold'>Condition:</span>  {condition} <span><small className='text-green-900'>{`${using_duration} Years`}</small></span></h2>
                    ...
                    <h2 className="card-title sm:text-lg text-xs"><span className='text-teal text-xs sm:text-2xl sm:font-bold'>Posted On:</span>  {time}</h2>
